...
| Usta olgan puli SERVIS balansidan ayriladi, ustunda esa "Oylik maoshlar"da qoladi | Ustalar reytingidagi "olgan pul" — oylik, u montaj (servis) pulidan beriladi (rahbar, 2026-08-13). Ilgari balansdan chiqmasdi: kassada allaqachon berib yuborilgan pul turgandek edi. Endi `kassaBalances` uni servis hamyonidan ayiradi, jadvalda esa avvalgi joyida — "Oylik maoshlar" ustunida |
| Oylik o'z ustunida turadi, xarajat ustunlariga qo'shilmaydi | Rahbar qoidasi (2026-08-13, ikki marta aytilgan). Ya'ni ustunlarni qo'shsa bo'ladi, lekin **"Servis xarajatlar" servis hamyonidan chiqqan puldan kam bo'ladi**: usta oyligi va olgan puli ham o'sha hamyondan chiqadi, faqat "Oylik maoshlar"da sanaladi. Hamyon raqami bosilsa hammasi ochiladi (`walletSources`) |
