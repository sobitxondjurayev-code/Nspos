...
| Usta olgan puli SERVIS kassasidan chiqadi | Ustalar reytingidagi "olgan pul" — oylik, va u montaj (servis) pulidan beriladi (rahbar, 2026-08-13). Shuning uchun u endi servis hamyonidan ayriladi (`kassaBalances`) va "Servis xarajatlar" ustuniga tushadi. Ilgari faqat "Oylik maoshlar"da ko'rinardi, balansdan esa chiqmasdi — kassada allaqachon berib yuborilgan pul turgandek edi |
