...
| Usta olgan puli SERVIS kassasidan chiqadi, "Oylik maoshlar"da ko'rinmaydi | Ustalar reytingidagi "olgan pul" — oylik, va u montaj (servis) pulidan beriladi (rahbar, 2026-08-13). Endi servis hamyonidan ayriladi (`kassaBalances`) va FAQAT "Servis xarajatlar" ustunida turadi. Ilgari teskarisi edi: "Oylik maoshlar"da ko'rinardi, balansdan esa chiqmasdi — kassada allaqachon berib yuborilgan pul turgandek edi |
| Pul rejasida "Oylik maoshlar" ustuni YO'Q (2026-08-13) | Rahbar olib tashlashni so'radi. Kerak ham emas: oylik qaysi qopdan berilgan bo'lsa o'sha ustunda turadi (servisdan — "Servis xarajatlar", do'kondan — "Do'kon xarajatlari"), ya'ni hech qanday pul tushib qolmaydi. "NS" esa "shundan" ustuni bo'lib qoldi |
