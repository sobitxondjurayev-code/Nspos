...
| Kimga to'lanadi — ro'yxatdan tanlanadi ("Boshqa" da izoh majburiy) | Har safar ism qo'lda yozilsa "Ravshan EZVIZ" va "Ravshan ezviz" ikki xil odam bo'lib qolardi, tarix bo'linib ketardi. Ro'yxat `PAYOUT_PAYEES` da, ilgari to'langan nomlar ham qo'shiladi (`payeeNames()`). "Boshqa" tanlansa izohsiz saqlanmaydi |
