...
// ══════════════════════════════════════════════════════════════
// EXCEL DAVRIDAGI P&L OLIB TASHLANDI (2026-09-05)
// ══════════════════════════════════════════════════════════════
// Bu yerda `sinceLedgerStart`, `pnlSource`, `billzPnlIsUploaded`,
// `pnlSourceGap`, `billzPnl`, `billzPnlTotals` va `billzCashflow`
// turardi — Billz'ning Excel eksportidan P&L va pul oqimini qurib,
// ilovaning o'z hisobi bilan yonma-yon ko'rsatish uchun edi.
//
// Ularning yagona iste'molchisi `finance/pnl` sahifasidagi
// `BillzCompare` komponenti edi; u tab ro'yxatida chaqirilmasdi va
// 2026-09-05 da olib tashlandi (DAFTAR 21), ya'ni bu funksiyalarni
// shundan keyin HECH KIM chaqirmadi.
//
// Nega qaytarilmaydi: 2026-08-19 dan Billz ma'lumoti API orqali
// keladi va qoida bitta — Billz uchun Excel/demo ZAXIRA YO'LI YO'Q,
// ko'zgu bitta (CLAUDE.md 2026-09-03). Ikki yo'l qolsa ertami-kechmi
// ikki xil raqam beradi va qaysi biri to'g'riligi bilinmaydi.
// Solishtiruv endi boshqa joyda: farq detektori
