...
const MINUS = "−";
// "−0": −0.004 yaxlitlanib "0" bo'ladi, lekin `v < 0` hamon rost —
// ekranda "−0 so'm" chiqardi (2026-09-03, menejerning Xarajatlar
// jadvalida). Belgi faqat ko'rinadigan raqam nolga teng bo'lmasa qo'yiladi.
const belgi = (v, matn) => (v < 0 && /[1-9]/.test(matn) ? MINUS + matn : matn);

// ══════════════════════════════════════════════════════════════
// NEGA MANFIY — bir sabab, bitta matn
// ══════════════════════════════════════════════════════════════
// Rahbar (2026-09-03): "Nima uchun tizimda '-' ishorali sonlar bor,
// bunday bo'lishi kerakmi?" Javob: minus HAQIQIY holatni bildiradi va
// har joyda o'z sababi bor. Sabab katakning o'zida ko'rinsin
// (`components/ui/Manfiy.jsx`) — rahbar so'rab o'tirmasin. Matn shu
// yerda, bir joyda: ikki sahifa bir holatni ikki xil tushuntirmasin.
export const MANFIY_SABAB = {
  hamyon: "Hamyon minusda: kassadan kirganidan ko'p pul chiqqan yoki topshirilgan. Odatda xarajat kun yopilgandan KEYIN kiritilgan — kunlik jadvalda qaysi kun ekani ko'rinadi.",
  kassaQoldi: "Ortiqcha topshirilgan: shu kuni kassada bo'lganidan ko'p pul berilgan. Odatda xarajat kun yopilgandan keyin kiritilgan.",
  kamomad: "Menejer yozgan naqd Billz cheklaridan kam — kamomad. Musbat bo'lsa ortiqcha.",
  kpiQoldiq: "Xodim ishlab topganidan ko'p pul olgan (avans yoki oldindan). Keyingi oy oyligidan chegiriladi.",
  ustaBalans: "O'tgan oy(lar)dan avans qolgan: usta olgan puli ishlab topganidan ko'p — shu oydan chegirilyapti.",
  sofFoyda: "Zarar: davrdagi tannarx va xarajatlar tushumdan ko'p.",
  pulOqimi: "Davrda kassadan chiqqan pul kirganidan ko'p.",
  rejaQoldiq: "Shu kunga rejalashtirilgan chiqim kassadagi puldan ko'p — reja bajarilsa kassa minusga tushadi.",
  foyda: "Tannarxdan arzon sotilgan yoki qaytarish — bu tovar bo'yicha zarar.",
  xizmatQoldiq: "Xizmat (montaj) omborda turmaydi — qoldig'i manfiy bo'lishi mumkin, bu xato emas.",
  inventar: "Kamomad: sanalgan miqdor tizimdagidan kam.",
  narx: "Narx tushirildi — qoldiq qiymati kamaydi.",
  qaytarish: "Qaytarish cheki: Billz qaytarilgan tovarni manfiy summa bilan beradi.",
  majburiyat: "Majburiyatlar aktivdan ko'p: hozirgi pul va qarzlar bilan hamma qarzni yopib bo'lmaydi.",
};
