...
import { getReorderDays, sozlama } from "./companyData";
...
export function stockCoverage({ windowDays = sozlama("stock.windowDays", 30), storeId = "all", storeIds = null, kesim = null, now = new Date() } = {}) {
...
export function reorderList({ windowDays = sozlama("stock.windowDays", 30), storeId = "all", kesim = null, leadDays = null, coverDays = null, now = new Date() } = {}) {
...
export function deadStock({ idleDays = 90, storeId = "all", kesim = null, now = new Date() } = {}) {
  ...
  const rows = stockCoverage({ windowDays: 30, storeId, kesim, now })
