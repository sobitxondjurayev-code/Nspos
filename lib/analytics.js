...
export function stockCoverage({ windowDays = sozlama("stock.windowDays", 30), storeId = "all", storeIds = null, now = new Date() } = {}) {
...
export function reorderList({ windowDays = sozlama("stock.windowDays", 30), storeId = "all", leadDays = null, coverDays = null, now = new Date() } = {}) {
