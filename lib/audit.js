...
export function moneyWarnings(user) {
  ...
  // Xarid tannarxning uchdan biridan kam bo'lsa — ombor kirimi hech
  // qayerda yozilmayapti: balansda ta'minotchi qarzi 0 turadi, ombor
  // harakati yopilmaydi. ODAM qiladigan ish (Billz'da "Приход") — bloklamaydi.
  // 05.09 o'lchov: avgust tannarx 91 162 $, Billz xarid hujjati 0, Pul
  // rejasi tovar to'lovi 37 594 $.
  if (isOwner) {
    ...
    if (tannarx > 1000 && billzXarid + tolov < tannarx / 3) {
      out.push({
