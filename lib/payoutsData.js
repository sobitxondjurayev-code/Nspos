...
export const PAYOUT_PAYEES = [
  ...
  "Jo'rabek Qoqon",
  "Abdulaziz Perevod",
  "Muhammad Vint Cosmos",
  "Isroil Qoqon Halowat",
  "Nurmuhammad",
  "Sobitxon",
...
// Ro'yxat o'zi o'sadi: ilgari to'langan nomlar ham qo'shiladi, shunda
// "Boshqa" orqali kiritilgan nom keyingi safar tanlovda turadi.
export function payeeNames() {
  const used = items.map((p) => String(p.title || "").trim()).filter(Boolean);
  return [...new Set([...PAYOUT_PAYEES, ...used])];
}
